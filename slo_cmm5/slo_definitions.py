"""SLI/SLO definitions + CMM level 1-5 checklist 
In the context of CMMI (Capability Maturity Model Integration), 
SLI and SLO are commonly used in IT Service Management (ITSM), 
DevOps, SRE (Site Reliability Engineering), and software quality measurement. 

They are not official CMMI maturity level terms, but they support CMMI practices related to
process measurement, quality, and performance.
